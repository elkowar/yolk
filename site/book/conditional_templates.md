...
It achieves this by commenting or uncommenting blocks of your file.
...
Now, this is of course not a valid configuration just yet, as we're setting the `displays` variable three times.
